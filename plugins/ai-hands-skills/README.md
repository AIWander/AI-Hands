...
Its five skills divide setup, dense ability-first routing, action-boundary safety, multi-step workflows, and sanctioned game sessions without adding duplicate tool owners. The instruction guide contains a small dispatch block that asks the model to invoke those skills at hook-like moments. That improves consistency but remains behavioral guidance, not enforcement.
